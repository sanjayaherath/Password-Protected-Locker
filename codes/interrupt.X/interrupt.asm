...
Main:
    ...
    bcf		PORTB,1
    ;bsf		INTCON,4	    ; enable RB0 interrupt bit
    bsf		STATUS,5
    ...
    movlw	b'00110000'	    ; 8:1 prescale . timer on
    movwf	T1CON
...
Menu_Select:			    ; select one option from available menu
    ...
    ;btfsc	statusreg,1	    ; check whether not operated for 10sec
    ;bsf		PORTB,1
...
Key_Init:				 ;Initalize keypad
    ...
    bsf		STATUS,5		;select bank 1
    movlw	b'11110000'		;0-4 outputs,5-7 inputs in portc
    movwf	KEYTRISC
    movlw	0x06	
